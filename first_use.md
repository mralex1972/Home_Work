...
9. Чтобы добавить в текст изображение, достаточно написать:      ![текст вместо изображения](имя файла с изображением). Например, ![Знакомьтесь, это Тефтелька](TefTELKA.jpg) Студентка, комсомолка, спортсменка!
